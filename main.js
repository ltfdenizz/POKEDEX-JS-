...
searcInput.addEventListener("input", (e) => {
  const searchValue = searcInput.value.toLowerCase();
...
const createPokemonCard = (pokemon) => {
  ...
  const pokemonDivİnnerHtml = ` <div class="image-container">
  <img
...
<div class="poke-info">
  ...
  <div class="small">
    <small class="poke-exp">
      <i class="fa solid fa-flask-vial"></i>${pokemon.base_experience} exp
    </small>
    <small class="poke-wight">
      <i class="fa solid fa-flask-vial"></i>${pokemon.weight} kg
    </small>
  </div>
  <div class="poke-type">
